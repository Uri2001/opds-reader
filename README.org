...
Requires [[https://git-scm.com/downloads][git]] and [[https://calibre-ebook.com/download][calibre]] installed (minimum calibre version: 6 (because the plugin now uses PyQt6)):
 - Clone the repository:
   #+BEGIN_EXAMPLE
     git clone https://github.com/epireyn/opds-reader.git
   #+END_EXAMPLE
...
** How do I use it?
This tool was created to backup book collections between two PCs in a home LAN, and that is the procedure documented here:
...
** License
This calibre plugin is copyright Steinar Bang, 2015-2022 & Edgar Pireyn 2026, and licensed Under GPL version 3.
